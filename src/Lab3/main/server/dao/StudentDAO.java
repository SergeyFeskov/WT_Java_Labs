...
public class StudentDAO {
    private static final String STUDENTS_XML = "src/Lab3/resources/students.xml";
    private static final String USERS_XML = "src/Lab3/resources/users.xml";
